          ...
          <div className="contact-layout">
            ...
            <div className="info-cards">
              {[
                ...
                { icon:<path d="M22 16.92v3a2 2 0 01-2.18 2 19.8 19.8 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.8 19.8 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.13 1 .37 1.97.72 2.89a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.92.35 1.88.59 2.89.72A2 2 0 0122 16.92z"/>, title:lang==='en'?'Phone & WhatsApp':'Teléfono y WhatsApp', lines:['+1 (786) 903-5295', lang==='en'?'WhatsApp available for quick inquiries':'WhatsApp disponible para consultas rápidas'], link:'https://wa.me/17869035295' },
                ...
                { icon:<><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></>, title:lang==='en'?'Shipping':'Envíos', lines:[lang==='en'?'Nationwide US distribution from Miami, FL.':'Distribución nacional desde Miami, FL.',lang==='en'?'Same-day dispatch before 2 PM EST.':'Despacho el mismo día antes de las 2 PM EST.'] },
              ].map((card, i) => (
